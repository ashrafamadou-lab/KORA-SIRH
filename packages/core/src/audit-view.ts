...
/** Clés dont la VALEUR est masquée d'office, quel que soit son contenu. */
const SECRET_KEY_RE =
  /(password|passwd|mot_?de_?passe|secret|token|jeton|otp|totp|mfa|credential|api_?key|apikey|private_?key|cle_?privee|hash|cookie|authorization)/i;
