...
const routesDemo = {
  ...
  'GET /auth/me': () => ({
    ...
    permissions: ['employees.view', 'employees.view_private', 'employees.view_identifiers', 'employees.view_documents',
      ...
      'leave.balance_view_own', 'leave.balance_view_team', 'leave.balance_view', 'leave.ledger_view',
      'leave.types_admin', 'leave.policies_admin', 'leave.accrual_run', 'leave.balance_adjust',
      'leave.openings_import', 'leave.sensitive_view',
      'leave.request_self', 'leave.request_for_others', 'leave.requests_view_own', 'leave.requests_view_team',
      'leave.requests_admin', 'leave.attachments_verify', 'leave.calendar_view', 'leave.calendar_export',
      'leave.request_cancel_approved', 'leave.request_retroactive',
  ...
  // ---------- Congés & absences (E11.1) — données de DÉMONSTRATION ----------
  'GET /leave/types': () => ({ items: DEMO_LEAVE_TYPES }),
  'GET /leave/policies': () => ({ items: [
    { id: uid(820), code: 'POL-CAP', labelFr: 'Congé annuel — régime général', labelEn: 'Annual leave — general', status: 'active',
      absenceTypeId: uid(810), typeCode: 'CAP', unit: 'open_days', countryCode: 'BJ', companyId: null, siteId: null,
      collectiveAgreement: null, professionalCategory: null, contractType: null, employeeStatus: null,
      seniorityMinMonths: null, workTime: 'any', populationKey: null, versionCount: 1, lastEffectiveFrom: '2025-01-01',
      versions: [{ version: 1, effectiveFrom: '2025-01-01', accrualMode: 'monthly', accrualRateParam: 'conges.acquisition.taux_mensuel',
        accrualRateValue: null, referencePeriod: 'calendar_year', rounding: 'half_up_0_5', carryOverMaxParam: null,
        carryOverMaxValue: 6, accrualRequiresService: false, prorataHire: true, prorataTermination: true,
        approvalLevels: 1, noticeDays: 15, minBlock: null, anticipationAllowed: false }] },
    { id: uid(821), code: 'POL-REC', labelFr: 'Récupération — service effectif', labelEn: 'Recovery — actual service', status: 'active',
      absenceTypeId: uid(812), typeCode: 'REC', unit: 'open_days', countryCode: null, companyId: null, siteId: null,
      collectiveAgreement: null, professionalCategory: null, contractType: null, employeeStatus: null,
      seniorityMinMonths: null, workTime: 'any', populationKey: null, versionCount: 1, lastEffectiveFrom: '2025-01-01',
      versions: [{ version: 1, effectiveFrom: '2025-01-01', accrualMode: 'monthly', accrualRateParam: null,
        accrualRateValue: 2, referencePeriod: 'calendar_year', rounding: 'none', carryOverMaxParam: null,
        carryOverMaxValue: 0, accrualRequiresService: true, prorataHire: true, prorataTermination: true,
        approvalLevels: 1, noticeDays: null, minBlock: null, anticipationAllowed: false }] },
  ] }),
  [`GET /leave/policies/${uid(820)}/population`]: () => ({ count: 27, sample: [] }),
  'GET /leave/accrual/runs': () => ({ items: [
    { id: uid(830), periodStart: '2026-07-01', periodEnd: '2026-07-31', scopeKind: 'tenant', reason: 'acquisition mensuelle de juillet',
      kind: 'accrual', status: 'completed', engineVersion: 'kora-leave-1.0.0', employeesCount: 27,
      entriesWritten: 52, entriesSkipped: 0, errorsCount: 0, errorReport: [], startedAt: '2026-08-01T05:00:00Z', finishedAt: '2026-08-01T05:00:02Z' },
    { id: uid(831), periodStart: '2026-07-01', periodEnd: '2026-07-31', scopeKind: 'tenant', reason: 'relance (preuve d’idempotence)',
      kind: 'accrual', status: 'completed', engineVersion: 'kora-leave-1.0.0', employeesCount: 27,
      entriesWritten: 0, entriesSkipped: 52, errorsCount: 0, errorReport: [], startedAt: '2026-08-01T05:10:00Z', finishedAt: '2026-08-01T05:10:01Z' },
    { id: uid(832), periodStart: '2026-01-01', periodEnd: '2026-01-31', scopeKind: 'tenant', reason: 'report 2025 → 2026',
      kind: 'carry_over', status: 'completed_with_errors', engineVersion: 'kora-leave-1.0.0', employeesCount: 27,
      entriesWritten: 41, entriesSkipped: 0, errorsCount: 1,
      errorReport: [{ matricule: 'SBT-0006', type: 'CAP', error: 'politiques ambiguës : POL-A, POL-B' }],
      startedAt: '2026-01-02T05:00:00Z', finishedAt: '2026-01-02T05:00:03Z' },
  ] }),
  'POST /leave/accrual/run': () => ({ run: { id: uid(833), periodStart: '2026-08-01', periodEnd: '2026-08-31', scopeKind: 'tenant',
    reason: 'démo', kind: 'accrual', status: 'completed', engineVersion: 'kora-leave-1.0.0', employeesCount: 27,
    entriesWritten: 52, entriesSkipped: 0, errorsCount: 0, errorReport: [], startedAt: '2026-08-03T09:00:00Z', finishedAt: '2026-08-03T09:00:02Z' } }),
  'GET /leave/balances': (q) => ({ items: DEMO_BALANCES.filter((b) => !q.get('employeeId') || b.employeeId === q.get('employeeId')) }),
  'GET /leave/balances/mine': () => ({ linked: true, items: DEMO_BALANCES.filter((b) => b.employeeId === uid(100)) }),
  'GET /leave/projection': (q) => ({ projection: {
    employeeId: uid(100), typeId: q.get('typeId') ?? uid(810), toDate: q.get('toDate') ?? '2026-12-31',
    currentAvailable: 14.5, projected: 24.5,
    plannedAccruals: [
      { effectiveOn: '2026-08-31', quantity: 2, monthLabel: '2026-08' },
      { effectiveOn: '2026-09-30', quantity: 2, monthLabel: '2026-09' },
      { effectiveOn: '2026-10-31', quantity: 2, monthLabel: '2026-10' },
      { effectiveOn: '2026-11-30', quantity: 2, monthLabel: '2026-11' },
      { effectiveOn: '2026-12-31', quantity: 2, monthLabel: '2026-12' },
    ],
    note: 'PROJECTION : distincte du droit définitivement acquis — les acquisitions futures restent conditionnelles',
    policyCode: 'POL-CAP', policyVersion: 1,
  } }),
  'GET /leave/ledger': (q) => ({ items: DEMO_LEDGER.filter((l) => !q.get('employeeId') || l.employeeId === q.get('employeeId')) }),
  'GET /leave/ledger/mine': () => ({ items: DEMO_LEDGER.filter((l) => l.employeeId === uid(100)) }),
  'POST /leave/adjust': () => ({ status: 'applied', before: 14.5, after: 15.5, entryId: uid(845) }),
  'POST /leave/openings/import': () => ({ kind: 'preview', counts: { received: 3, accepted: 2, duplicated: 1, rejected: 0 }, errors: [], importId: null }),
  'GET /leave/openings': () => ({ items: [
    { id: uid(850), filename: 'reprise-2026.csv', asOfDate: '2026-01-01', status: 'applied', atomic: true,
      linesReceived: 27, linesAccepted: 27, linesDuplicated: 0, linesRejected: 0, errorReport: [], sourceNote: 'reprise SIRH précédent', createdAt: '2026-01-02T08:00:00Z' },
  ] }),
  // ---- E11.2 : demandes de congés ----
  'POST /leave/requests': () => ({ id: uid(860), onBehalf: false }),
  [`POST /leave/requests/${uid(860)}`]: () => ({ updated: true }),
  [`GET /leave/requests/preview/${uid(860)}`]: () => ({ preview: {
    requestId: uid(860), status: 'draft', version: 0, quantity: 4, unit: 'open_days',
    detail: [
      { date: '2026-09-07', counted: 1, why: 'journée planifiée (08:00–17:00)' },
      { date: '2026-09-08', counted: 1, why: 'journée planifiée (08:00–17:00)' },
      { date: '2026-09-09', counted: 1, why: 'journée planifiée (08:00–17:00)' },
      { date: '2026-09-10', counted: 0, why: 'férié (Férié démo)' },
      { date: '2026-09-11', counted: 1, why: 'journée planifiée (08:00–17:00)' },
    ],
    errors: [], checks: [], blocking: false,
    available: 14.5, afterAvailable: 10.5, projectedAtStart: 16.5,
    projectionNote: 'PROJECTION : acquisitions futures conditionnelles — le solde projeté n’est pas un droit acquis',
    retroactive: false, circuit: 'conges_demande', policyCode: 'POL-CAP', policyVersion: 1,
  } }),
  [`POST /leave/requests/${uid(860)}/submit`]: () => ({ instanceId: uid(861), version: 1, quantity: 4, checks: [] }),
  [`GET /leave/requests/preview/${uid(862)}`]: () => ({ preview: {
    requestId: uid(862), status: 'in_review', version: 1, quantity: 4, unit: 'open_days',
    detail: [
      { date: '2026-09-07', counted: 1, why: 'journée planifiée (08:00–17:00)' },
      { date: '2026-09-08', counted: 1, why: 'journée planifiée (08:00–17:00)' },
      { date: '2026-09-09', counted: 1, why: 'journée planifiée (08:00–17:00)' },
  ...
  'GET /leave/requests/mine': () => ({ items: DEMO_REQUESTS.filter((r) => r.matricule === 'SBT-0001') }),
  'GET /leave/requests/team': () => ({ items: DEMO_REQUESTS, delayDays: null }),
  'GET /leave/requests/queue': (q) => ({
    items: DEMO_REQUESTS.filter((r) => (q.get('sensitive') !== '1' || r.confidential)
      && (q.get('retro') !== '1' || r.retroactive) && (q.get('failed') !== '1' || r.status === 'application_failed')),
    delayDays: 3,
  }),
  [`GET /leave/requests/${uid(862)}`]: () => ({ request: {
    ...DEMO_REQUESTS[0], onBehalfReason: null, instanceId: uid(861), cancelInstanceId: null, createdBy: uid(1),
    versions: [{ version: 1, startDate: '2026-09-07', endDate: '2026-09-11', halfDayStart: false, halfDayEnd: false,
      hours: null, quantity: '4.000', unit: 'open_days', checks: [], countDetail: [], retroactive: false,
      retroReason: null, comment: 'congés de septembre', policyId: uid(820), policyVersion: 1,
      instanceId: uid(861), createdAt: '2026-08-03T09:00:00Z' }],
    events: [
      { version: null, event: 'created', actorUserId: uid(1), detail: {}, createdAt: '2026-08-03T08:58:00Z' },
      { version: 1, event: 'submitted', actorUserId: uid(1), detail: {}, createdAt: '2026-08-03T09:00:00Z' },
      { version: 1, event: 'reservation_posted', actorUserId: uid(1), detail: { quantity: 4 }, createdAt: '2026-08-03T09:00:00Z' },
      { version: 1, event: 'review_started', actorUserId: uid(2), detail: {}, createdAt: '2026-08-03T10:12:00Z' },
    ],
    attachments: [],
  } }),
  [`GET /leave/requests/${uid(863)}`]: () => ({ request: {
    ...DEMO_REQUESTS[1], onBehalfReason: null, instanceId: uid(864), cancelInstanceId: null, createdBy: uid(1),
    versions: [{ version: 1, startDate: '2026-09-21', endDate: '2026-09-23', halfDayStart: false, halfDayEnd: false,
      hours: null, quantity: '3.000', unit: 'calendar_days', checks: [], countDetail: [], retroactive: false,
      retroReason: null, comment: 'motif confidentiel', policyId: null, policyVersion: null,
      instanceId: uid(864), createdAt: '2026-08-03T11:00:00Z' }],
    events: [
      { version: 1, event: 'submitted', actorUserId: uid(1), detail: {}, createdAt: '2026-08-03T11:00:00Z' },
      { version: 1, event: 'attachment_added', actorUserId: uid(1), detail: {}, createdAt: '2026-08-03T11:01:00Z' },
    ],
    attachments: [{ id: uid(865), filename: 'certificat.pdf', mime: 'application/pdf', byteSize: 42000,
      sensitive: true, verifiedStatus: 'unverified', createdAt: '2026-08-03T11:01:00Z' }],
  } }),
  [`POST /leave/requests/${uid(862)}/decide`]: () => ({ status: 'in_review' }),
  [`POST /leave/requests/${uid(862)}/withdraw`]: () => ({}),
  'GET /leave/calendar': () => ({ calendar: {
    from: '2026-09-07', to: '2026-09-25',
    employees: EMP.slice(0, 5).map((e, i) => ({ id: uid(100 + i), matricule: e[0], firstName: e[1], lastName: e[2] })),
    entries: [
      { employeeId: uid(100), startDate: '2026-09-07', endDate: '2026-09-11', status: 'approved',
        labelMode: 'detail', typeCode: 'CAP', labelFr: 'Congé annuel payé', labelEn: 'Paid annual leave' },
      { employeeId: uid(101), startDate: '2026-09-21', endDate: '2026-09-23', status: 'approved',
        labelMode: 'unavailable', typeCode: null, labelFr: 'Indisponible', labelEn: 'Unavailable' },
      { employeeId: uid(102), startDate: '2026-09-14', endDate: '2026-09-15', status: 'pending',
        labelMode: 'detail', typeCode: 'REC', labelFr: 'Récupération', labelEn: 'Recovery' },
    ],
    holidays: [{ date: '2026-09-10', label: 'Férié démo' }],
    days: [{ date: '2026-09-07', headcount: 27, approvedAbsent: 1, pendingAbsent: 0 }],
    alerts: [{ date: '2026-09-21', present: 25, minPresence: 26, level: 'alert' }],
    minPresence: 26,
  } }),
  'GET /leave/calendar/export': () => ({ csv: 'matricule;nom;debut;fin;statut;libelle' }),
  // ---- E11.3 : intégration présence, clôture congés, exports paie, rapports ----
  'GET /leave/periods': () => ({ items: [
    { id: uid(880), label: 'Congés septembre 2026', periodStart: '2026-09-01', periodEnd: '2026-09-30',
      status: 'closed', revision: 1, closeCount: 1,
      activeFingerprint: 'a3f18c2be94d70655c14e8d0912f4ab6c07d3ee15b28f4a9d6c01e7b52a90f34' },
    { id: uid(881), label: 'Congés octobre 2026', periodStart: '2026-10-01', periodEnd: '2026-10-31',
      status: 'open', revision: 1, closeCount: 0, activeFingerprint: null },
  ] }),
  'POST /leave/periods': () => ({ id: uid(882) }),
  [`GET /leave/periods/${uid(880)}/preclose`]: () => ({ preclose: {
    periodId: uid(880), label: 'Congés septembre 2026', status: 'closed', revision: 1,
    blocking: [], warnings: [],
  } }),
  [`GET /leave/periods/${uid(881)}/preclose`]: () => ({ preclose: {
    periodId: uid(881), label: 'Congés octobre 2026', status: 'open', revision: 1,
    blocking: [{ code: 'approved_not_applied', level: 'blocking', count: 1, detail: 'demandes approuvées non appliquées' }],
    warnings: [
      { code: 'pending_requests', level: 'warning', count: 2, detail: 'demandes soumises ou en instruction sur la période' },
      { code: 'time_periods_open', level: 'warning', count: 1, detail: 'périodes de présence non closes' },
    ],
  } }),
  [`POST /leave/periods/${uid(881)}/close`]: () => ({ closeId: uid(883), closeNo: 1,
    fingerprint: 'b7c2d90e14fa38255c60e1a7b3d94c08f2ae65d11c37b8e0f49a52d6c1038e72', linesCount: 41, warnings: [] }),
  [`POST /leave/periods/${uid(880)}/reopen`]: () => ({ instanceId: uid(884) }),
  [`GET /leave/periods/${uid(880)}/closes`]: () => ({ items: [
    { id: uid(885), closeNo: 1, periodRevision: 1, engineVersion: 'kora-leave-close-1.0.0',
      fingerprint: 'a3f18c2be94d70655c14e8d0912f4ab6c07d3ee15b28f4a9d6c01e7b52a90f34',
      employeesCount: 27, linesCount: 41, movementsCount: 168,
      totals: { open_days: { accrued: 405.5, consumed: 92, available: 288.5 } },
      warnings: [{ code: 'pending_requests', level: 'warning', count: 1, detail: 'demandes en instruction' }],
      status: 'active', closedAt: '2026-10-02T08:30:00Z' },
  ] }),
  [`GET /leave/closes/${uid(885)}/verify`]: () => ({
    stored: 'a3f18c2be94d70655c14e8d0912f4ab6c07d3ee15b28f4a9d6c01e7b52a90f34',
    recomputed: 'a3f18c2be94d70655c14e8d0912f4ab6c07d3ee15b28f4a9d6c01e7b52a90f34', match: true }),
  [`POST /leave/closes/${uid(885)}/exports`]: () => ({ exportId: uid(886), revision: 1,
    sha256: 'c9e4f1a2d38b60755c22e7d4901f5cb8a16d3fe27b49c5a0d7e12f8b63a41e05', reused: false }),
  [`GET /leave/closes/${uid(885)}/exports`]: () => ({ items: [
    { id: uid(886), schemaVersion: 'kora-conges-prep-1', format: 'csv', revision: 1,
      sha256: 'c9e4f1a2d38b60755c22e7d4901f5cb8a16d3fe27b49c5a0d7e12f8b63a41e05',
      timeCloses: [{ id: uid(887), label: 'Présence septembre 2026', closeNo: 2,
        fingerprint: 'd1a7e2c48f3b90655c88e5d2716f0ab4c93d2ef06b15a7c8d4e90f2b31c56e88' }],
      employeesCount: 27, errorReport: [], status: 'active', generatedAt: '2026-10-02T09:00:00Z' },
    { id: uid(888), schemaVersion: 'kora-conges-prep-1', format: 'json', revision: 1,
      sha256: 'e2b8f3c50a4d71855c99e6d38270fbc5a04e3ff17c26b8d9e5f01a3c42d67f99',
      timeCloses: [{ id: uid(887), label: 'Présence septembre 2026', closeNo: 2,
        fingerprint: 'd1a7e2c48f3b90655c88e5d2716f0ab4c93d2ef06b15a7c8d4e90f2b31c56e88' }],
      employeesCount: 27, errorReport: [], status: 'active', generatedAt: '2026-10-02T09:01:00Z' },
  ] }),
  [`GET /leave/prep-exports/${uid(886)}/download`]: () => ({
    filename: 'conges-prep-demo-r1.csv', format: 'csv',
    contentBase64: btoa('module;origine;matricule;categorie;jours;heures;corrections\nconges;absence_appliquee;SBT-0001;conge_paye;4;0;0'),
    sha256: 'c9e4f1a2d38b60755c22e7d4901f5cb8a16d3fe27b49c5a0d7e12f8b63a41e05' }),
  'GET /leave/integration': () => ({ integration: {
    facts: [{ status: 'active', count: 9 }, { status: 'pending_closed_period', count: 2 }, { status: 'superseded', count: 3 }],
    impacts: [{ impact: 'applied', count: 3 }, { impact: 'pending_closed_period', count: 1 }, { impact: 'superseded', count: 1 }],
    pending: [{ absenceId: uid(890), employeeId: uid(100), matricule: 'SBT-0001',
      from: '2026-07-06', to: '2026-07-07', days: 2 }],
  } }),
  'POST /leave/integration/run': () => ({ activated: 0, integrated: 0, recalculated: 0, resolvedAnomalies: 0, stillPending: 2 }),
  'GET /leave/reports': () => ({ report: {
    from: '2026-01-01', to: '2026-09-30',
    balances: [{ unit: 'open_days', accrued: 405.5, reserved: 12, consumed: 92, expired: 4.5, available: 288.5 }],
    utilization: 0.227,
    requests: [{ status: 'applied', count: 14 }, { status: 'in_review', count: 2 }, { status: 'rejected', count: 1 }],
    avgProcessingHours: 26.4,
    byCategory: [
      { category: 'conge_paye', days: 74, hours: 0, absences: 12 },
      { category: 'maladie', days: 11, hours: 0, absences: 3 },
      { category: 'mission_formation', days: 0, hours: 12.5, absences: 2 },
    ],
    byUnit: [{ unitId: uid(20), code: 'PROD', days: 51 }, { unitId: uid(21), code: 'ADM', days: 34 }],
    retroRequests: 2, failedApplications: 1, carriedInExposure: 18.5,
    note: 'Agrégats sans motif ni donnée médicale.',
  } }),
  // ---- E12.1 : paie brute ----
  'GET /payroll/calendars': () => ({ items: [
    { id: uid(900), code: 'MENS', labelFr: 'Mensuel', labelEn: 'Monthly', frequency: 'monthly', status: 'active', periodCount: 2 },
  ] }),
  'POST /payroll/calendars': () => ({ id: uid(901) }),
  'GET /payroll/periods': () => ({ items: [
    { id: uid(902), label: 'Paie septembre 2026', periodStart: '2026-09-01', periodEnd: '2026-09-30',
      payDate: '2026-09-30', status: 'locked', revision: 1, calendarCode: 'MENS', runCount: 2, currentResults: 27 },
    { id: uid(903), label: 'Paie octobre 2026', periodStart: '2026-10-01', periodEnd: '2026-10-31',
      payDate: '2026-10-31', status: 'open', revision: 1, calendarCode: 'MENS', runCount: 0, currentResults: 0 },
  ] }),
  'POST /payroll/periods': () => ({ id: uid(904) }),
  [`POST /payroll/periods/${uid(902)}/status`]: () => ({ status: 'validated' }),
  [`POST /payroll/periods/${uid(902)}/reopen`]: () => ({ instanceId: uid(905) }),
  [`GET /payroll/periods/${uid(902)}/runs`]: () => ({ items: [
    { id: uid(906), periodRevision: 1, scopeKind: 'tenant', reason: 'paie de septembre', status: 'completed',
      engineVersion: 'kora-payroll-gross-1.0.0', employeesCount: 27, resultsCount: 27, errors: [],
      fingerprint: 'f2a91c7d4e8b30556c11a9e2470d3fb8c05e6da39b17c4f8e2d90a5b63c14807',
      timeCloseId: uid(907), leaveCloseId: uid(908), startedAt: '2026-10-01T08:00:00Z', finishedAt: '2026-10-01T08:00:12Z' },
  ] }),
  [`GET /payroll/periods/${uid(902)}/results`]: () => ({ items: [
    { id: uid(910), employeeId: uid(100), matricule: 'SBT-0001', firstName: 'Awa', lastName: 'Sossou',
      version: 2, isCurrent: true, currency: 'XOF', grossAmount: '360000.0000', taxableBase: '335000.0000',
      contributableBase: '335000.0000', linesCount: 4,
      inputsSha256: 'a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90',
      engineVersion: 'kora-payroll-gross-1.0.0', computedAt: '2026-10-01T08:00:11Z', runId: uid(906) },
    { id: uid(911), employeeId: uid(100), matricule: 'SBT-0001', firstName: 'Awa', lastName: 'Sossou',
      version: 1, isCurrent: false, currency: 'XOF', grossAmount: '340000.0000', taxableBase: '315000.0000',
      contributableBase: '315000.0000', linesCount: 4,
      inputsSha256: 'b1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f91',
      engineVersion: 'kora-payroll-gross-1.0.0', computedAt: '2026-09-30T18:20:00Z', runId: uid(906) },
  ] }),
  'GET /payroll/structures': () => ({ items: [
    { id: uid(920), code: 'CADRE', labelFr: 'Cadre', labelEn: 'Staff', status: 'active',
      rubrics: [{ rubricId: uid(930), code: 'BASE', sequence: 10 }, { rubricId: uid(931), code: 'ANC', sequence: 20 },
                { rubricId: uid(932), code: 'NUIT', sequence: 30 }, { rubricId: uid(933), code: 'TRANSP', sequence: 40 }] },
  ] }),
  'GET /payroll/rubrics': () => ({ items: [
    { id: uid(930), code: 'BASE', labelFr: 'Salaire de base', labelEn: 'Base salary', kind: 'gain',
      taxable: true, cotisable: true, sequence: 10, status: 'active', used: true,
      versions: [{ id: uid(940), version: 1, effectiveFrom: '2025-01-01', valuation: 'rate', fixedValue: null,
        rateValue: '1.000000', rateParamKey: null, rateBase: 'base.montant', formula: null, eligibility: null,
        proration: 'none', capValue: null, capParamKey: null, floorValue: null, roundingDp: null }] },
    { id: uid(931), code: 'ANC', labelFr: 'Prime d’ancienneté', labelEn: 'Seniority bonus', kind: 'prime',
      taxable: true, cotisable: true, sequence: 20, status: 'active', used: true,
      versions: [{ id: uid(941), version: 1, effectiveFrom: '2025-01-01', valuation: 'formula', fixedValue: null,
        rateValue: null, rateParamKey: null, rateBase: null,
        formula: { k: 'if', cond: { k: 'gte', a: { k: 'var', name: 'emp.anciennete_mois' }, b: { k: 'num', v: 24 } },
          then: { k: 'mul', a: { k: 'var', name: 'base.montant' }, b: { k: 'param', key: 'paie.prime.anciennete' } },
          else: { k: 'num', v: 0 } },
        eligibility: null, proration: 'none', capValue: null, capParamKey: null, floorValue: null, roundingDp: null }] },
    { id: uid(932), code: 'NUIT', labelFr: 'Majoration de nuit', labelEn: 'Night premium', kind: 'prime',
      taxable: true, cotisable: true, sequence: 30, status: 'active', used: true,
      versions: [{ id: uid(942), version: 1, effectiveFrom: '2025-01-01', valuation: 'formula', fixedValue: null,
        rateValue: null, rateParamKey: null, rateBase: null,
        formula: { k: 'mul', a: { k: 'var', name: 'temps.heures_nuit' }, b: { k: 'param', key: 'paie.majoration.nuit' } },
        eligibility: null, proration: 'none', capValue: null, capParamKey: null, floorValue: null, roundingDp: null }] },
    { id: uid(933), code: 'TRANSP', labelFr: 'Indemnité de transport', labelEn: 'Transport allowance', kind: 'indemnite',
      taxable: false, cotisable: false, sequence: 40, status: 'active', used: true,
      versions: [{ id: uid(943), version: 1, effectiveFrom: '2025-01-01', valuation: 'fixed', fixedValue: '40000.0000',
        rateValue: null, rateParamKey: null, rateBase: null, formula: null, eligibility: null, proration: 'none',
        capValue: null, capParamKey: 'paie.plafond.transport', floorValue: null, roundingDp: null }] },
  ] }),
  'POST /payroll/simulate': () => ({ simulation: DEMO_PAYROLL_LINES('SIMULATION') }),
  'POST /payroll/runs': () => ({ runId: uid(906), status: 'completed', employeesCount: 27, resultsCount: 27,
    errors: [], fingerprint: 'f2a91c7d4e8b30556c11a9e2470d3fb8c05e6da39b17c4f8e2d90a5b63c14807' }),
  [`GET /payroll/results/${uid(910)}`]: () => ({ result: {
    id: uid(910), periodId: uid(902), periodLabel: 'Paie septembre 2026', periodStart: '2026-09-01',
    periodEnd: '2026-09-30', payDate: '2026-09-30', employeeId: uid(100), matricule: 'SBT-0001',
    version: 2, isCurrent: true, currency: 'XOF', grossAmount: '360000.0000', taxableBase: '335000.0000',
    contributableBase: '335000.0000',
    inputsSha256: 'a1b2c3d4e5f60718293a4b5c6d7e8f90a1b2c3d4e5f60718293a4b5c6d7e8f90',
    engineVersion: 'kora-payroll-gross-1.0.0', timeCloseId: uid(907), leaveCloseId: uid(908),
    paramsUsed: {
      'paie.prime.anciennete': { value: 0.05, parameterId: uid(950), effectiveFrom: '2020-01-01', source: 'parametre' },
      'paie.majoration.nuit': { value: 1250, parameterId: uid(951), effectiveFrom: '2020-01-01', source: 'parametre' },
      'paie.plafond.transport': { value: 25000, parameterId: uid(952), effectiveFrom: '2020-01-01', source: 'parametre' },
    },
    inputsUsed: { 'base.montant': 300000, 'temps.heures_nuit': 16, 'emp.anciennete_mois': 45 },
    computedAt: '2026-10-01T08:00:11Z',
    lines: DEMO_PAYROLL_LINES('RESULTAT').lines,
  } }),
  [`GET /payroll/results/${uid(910)}/compare`]: () => ({ comparison: {
    from: { id: uid(911), version: 1, gross: 340000, inputsSha256: 'b1b2c3d4' },
    to: { id: uid(910), version: 2, gross: 360000, inputsSha256: 'a1b2c3d4' },
    grossDelta: 20000, sameInputs: false,
    differences: [{ code: 'NUIT', before: 0, after: 20000, delta: 20000, change: 'modifiee' }],
  } }),
  'GET /payroll/levies': () => ({ items: [
    { id: uid(960), code: 'CNSS-SAL', labelFr: 'CNSS part salariale', labelEn: 'Employee social contribution',
      kind: 'salarial', baseKind: 'cotisable', status: 'draft',
      versions: [{ version: 1, effectiveFrom: '2026-01-01', rateParamKey: 'cnss.taux.salarial',
        ceilingParamKey: 'cnss.plafond.mensuel', floorParamKey: null, exemption: null }] },
  ], note: 'E12.1 déclare les prélèvements et leurs clés de paramètres ; AUCUN n’est calculé — seules les assiettes sont produites.' }),
};

/** Lignes de paie de DÉMONSTRATION, expliquées étape par étape. */
function DEMO_PAYROLL_LINES(mode) {
  const lines = [
    { sequence: 1, code: 'BASE', labelFr: 'Salaire de base', labelEn: 'Base salary', kind: 'gain',
      taxable: true, cotisable: true, valuation: 'rate', base: 300000, rate: 1, quantity: null, amount: 300000,
      trace: [{ step: 1, op: 'base', detail: 'base.montant', value: 300000 },
              { step: 2, op: 'taux', detail: 'valeur interne assumée', value: 1 },
              { step: 3, op: 'multiplication', detail: 'base × taux', value: 300000 }],
      inputsUsed: { 'base.montant': 300000 }, paramsUsed: {} },
    { sequence: 2, code: 'ANC', labelFr: 'Prime d’ancienneté', labelEn: 'Seniority bonus', kind: 'prime',
      taxable: true, cotisable: true, valuation: 'formula', base: null, rate: null, quantity: null, amount: 15000,
      trace: [{ step: 1, op: 'variable', detail: 'emp.anciennete_mois', value: 45 },
              { step: 2, op: 'littéral', detail: '24', value: 24 },
              { step: 3, op: 'variable', detail: 'base.montant', value: 300000 },
              { step: 4, op: 'paramètre', detail: 'paie.prime.anciennete (parametre, effet 2020-01-01)', value: 0.05 },
              { step: 5, op: 'multiplication', detail: '×', value: 15000 },
              { step: 6, op: 'condition', detail: 'vraie', value: 15000 }],
      inputsUsed: { 'emp.anciennete_mois': 45, 'base.montant': 300000 },
      paramsUsed: { 'paie.prime.anciennete': { value: 0.05, parameterId: uid(950), effectiveFrom: '2020-01-01', source: 'parametre' } } },
    { sequence: 3, code: 'NUIT', labelFr: 'Majoration de nuit', labelEn: 'Night premium', kind: 'prime',
      taxable: true, cotisable: true, valuation: 'formula', base: null, rate: null, quantity: null, amount: 20000,
      trace: [{ step: 1, op: 'variable', detail: 'temps.heures_nuit', value: 16 },
              { step: 2, op: 'paramètre', detail: 'paie.majoration.nuit (parametre, effet 2020-01-01)', value: 1250 },
              { step: 3, op: 'multiplication', detail: '×', value: 20000 }],
      inputsUsed: { 'temps.heures_nuit': 16 },
      paramsUsed: { 'paie.majoration.nuit': { value: 1250, parameterId: uid(951), effectiveFrom: '2020-01-01', source: 'parametre' } } },
    { sequence: 4, code: 'TRANSP', labelFr: 'Indemnité de transport', labelEn: 'Transport allowance', kind: 'indemnite',
      taxable: false, cotisable: false, valuation: 'fixed', base: null, rate: null, quantity: null, amount: 25000,
      trace: [{ step: 1, op: 'montant fixe', detail: 'valeur de la version de rubrique', value: 40000 },
              { step: 2, op: 'plafond', detail: 'paie.plafond.transport (parametre)', value: 25000 }],
      inputsUsed: {},
      paramsUsed: { 'paie.plafond.transport': { value: 25000, parameterId: uid(952), effectiveFrom: '2020-01-01', source: 'parametre' } } },
  ];
  return {
    periodId: uid(902), periodLabel: 'Paie septembre 2026', periodStart: '2026-09-01', periodEnd: '2026-09-30',
    payDate: '2026-09-30', employeeId: uid(100), currency: 'XOF',
    engineVersion: 'kora-payroll-gross-1.0.0', timeCloseId: uid(907), leaveCloseId: uid(908), roundingDp: 0,
    gross: 360000, taxableBase: 335000, contributableBase: 335000,
    lines, skipped: [], errors: [],
    variables: { 'base.montant': 300000, 'temps.heures_nuit': 16, 'emp.anciennete_mois': 45,
      'temps.jours_attendus': 22, 'temps.jours_presents': 22, 'conges.jours_conge_paye': 0 },
    paramsUsed: {
      'paie.prime.anciennete': { value: 0.05, parameterId: uid(950), effectiveFrom: '2020-01-01', source: 'parametre' },
      'paie.majoration.nuit': { value: 1250, parameterId: uid(951), effectiveFrom: '2020-01-01', source: 'parametre' },
      'paie.plafond.transport': { value: 25000, parameterId: uid(952), effectiveFrom: '2020-01-01', source: 'parametre' },
...
const DEMO_REQUESTS = [
  { id: uid(862), status: 'in_review', version: 1, onBehalf: false, source: 'ess',
    typeCode: 'CAP', labelFr: 'Congé annuel payé', labelEn: 'Paid annual leave', confidential: false,
    matricule: 'SBT-0001', firstName: 'Awa', lastName: 'Sossou',
    startDate: '2026-09-07', endDate: '2026-09-11', quantity: '4.000', unit: 'open_days',
    retroactive: false, comment: 'congés de septembre', submittedAt: '2026-08-03T09:00:00Z',
    attachmentCount: 0, attachmentStatus: null },
  { id: uid(863), status: 'submitted', version: 1, onBehalf: false, source: 'ess',
    typeCode: null, labelFr: 'Absence', labelEn: 'Absence', confidential: true,
    matricule: 'SBT-0001', firstName: 'Awa', lastName: 'Sossou',
    startDate: '2026-09-21', endDate: '2026-09-23', quantity: '3.000', unit: 'calendar_days',
    retroactive: false, comment: 'motif confidentiel', submittedAt: '2026-08-03T11:00:00Z',
    attachmentCount: 1, attachmentStatus: 'unverified' },
  { id: uid(866), status: 'application_failed', version: 1, onBehalf: true, source: 'rh',
    typeCode: 'REC', labelFr: 'Récupération', labelEn: 'Recovery', confidential: false,
    matricule: 'SBT-0003', firstName: 'Chantal', lastName: 'Dossou',
    startDate: '2026-07-06', endDate: '2026-07-07', quantity: '2.000', unit: 'open_days',
    retroactive: true, comment: 'régularisation', submittedAt: '2026-08-01T15:00:00Z',
    attachmentCount: 0, attachmentStatus: null },
];

/** Types d'absence de DÉMONSTRATION. */
const DEMO_LEAVE_TYPES = [
  { id: uid(810), code: 'CAP', labelFr: 'Congé annuel payé', labelEn: 'Paid annual leave', category: 'legal', paid: true,
    unit: 'open_days', affectsPresence: true, affectsPayrollPrep: true, justification: 'none', depositDelayDays: 15,
    retroactiveAllowed: false, negativeAllowed: false, confidential: false, workflowRequired: true,
    status: 'active', effectiveFrom: '2025-01-01', effectiveTo: null, policyCount: 1, used: true },
  { id: uid(811), code: 'MAL', labelFr: 'Maladie', labelEn: 'Sickness', category: 'legal', paid: true,
    unit: 'calendar_days', affectsPresence: true, affectsPayrollPrep: true, justification: 'required', depositDelayDays: 2,
    retroactiveAllowed: true, negativeAllowed: false, confidential: true, workflowRequired: true,
    status: 'active', effectiveFrom: '2025-01-01', effectiveTo: null, policyCount: 0, used: true },
  { id: uid(812), code: 'REC', labelFr: 'Récupération', labelEn: 'Recovery', category: 'internal', paid: false,
    unit: 'open_days', affectsPresence: true, affectsPayrollPrep: false, justification: 'none', depositDelayDays: null,
    retroactiveAllowed: false, negativeAllowed: false, confidential: false, workflowRequired: true,
    status: 'active', effectiveFrom: '2025-01-01', effectiveTo: null, policyCount: 1, used: false },
];

/** Soldes de DÉMONSTRATION — buckets = somme du ledger, jamais un champ libre. */
const DEMO_BALANCES = [
  { employeeId: uid(100), absenceTypeId: uid(810), unit: 'open_days', periodStart: '2026-01-01', periodEnd: '2026-12-31',
    accrued: 20.5, adjustedOut: 0, carriedIn: 6, expired: 0, reserved: 3, consumed: 3, available: 14.5,
    typeCode: 'CAP', typeLabelFr: 'Congé annuel payé', typeLabelEn: 'Paid annual leave', confidential: false,
    matricule: 'SBT-0001', firstName: 'Awa', lastName: 'Sossou' },
  { employeeId: uid(100), absenceTypeId: uid(812), unit: 'open_days', periodStart: '2026-01-01', periodEnd: '2026-12-31',
    accrued: 4, adjustedOut: 0, carriedIn: 0, expired: 0, reserved: 0, consumed: 2, available: 2,
    typeCode: 'REC', typeLabelFr: 'Récupération', typeLabelEn: 'Recovery', confidential: false,
    matricule: 'SBT-0001', firstName: 'Awa', lastName: 'Sossou' },
  { employeeId: uid(101), absenceTypeId: uid(810), unit: 'open_days', periodStart: '2026-01-01', periodEnd: '2026-12-31',
    accrued: 14, adjustedOut: 0.5, carriedIn: 0, expired: 0, reserved: 0, consumed: 6, available: 7.5,
    typeCode: 'CAP', typeLabelFr: 'Congé annuel payé', typeLabelEn: 'Paid annual leave', confidential: false,
    matricule: 'SBT-0002', firstName: 'Bio', lastName: 'Kassim' },
];

/** Ledger de DÉMONSTRATION (append-only). */
const DEMO_LEDGER = [
  { id: uid(840), employeeId: uid(100), matricule: 'SBT-0001', firstName: 'Awa', lastName: 'Sossou',
    absenceTypeId: uid(810), typeCode: 'CAP', confidential: false, policyId: uid(820), policyVersion: 1,
    periodStart: '2026-01-01', periodEnd: '2026-12-31', entryKind: 'carry_over', quantity: 6, unit: 'open_days',
    effectiveOn: '2026-01-01', origin: 'carry_over_job', businessRef: null, reason: null, reversalOf: null,
    paramsUsed: {}, idempotencyKey: 'carryover:demo', createdBy: null, createdAt: '2026-01-02T05:00:00Z' },
  { id: uid(841), employeeId: uid(100), matricule: 'SBT-0001', firstName: 'Awa', lastName: 'Sossou',
    absenceTypeId: uid(810), typeCode: 'CAP', confidential: false, policyId: uid(820), policyVersion: 1,
    periodStart: '2026-01-01', periodEnd: '2026-12-31', entryKind: 'accrual', quantity: 2, unit: 'open_days',
    effectiveOn: '2026-07-31', origin: 'system_accrual', businessRef: 'run:demo:2026-07', reason: null, reversalOf: null,
    paramsUsed: { 'conges.acquisition.taux_mensuel': { value: 2, source: 'parametre' } },
    idempotencyKey: 'accrual:demo:2026-07', createdBy: null, createdAt: '2026-08-01T05:00:00Z' },
  { id: uid(842), employeeId: uid(100), matricule: 'SBT-0001', firstName: 'Awa', lastName: 'Sossou',
    absenceTypeId: uid(810), typeCode: 'CAP', confidential: false, policyId: null, policyVersion: null,
    periodStart: '2026-01-01', periodEnd: '2026-12-31', entryKind: 'reservation', quantity: 3, unit: 'open_days',
    effectiveOn: '2026-08-10', origin: 'workflow', businessRef: null, reason: 'demande de congé (E11.2, à venir)', reversalOf: null,
    paramsUsed: {}, idempotencyKey: 'resv:demo', createdBy: uid(500), createdAt: '2026-08-02T10:00:00Z' },
  { id: uid(843), employeeId: uid(101), matricule: 'SBT-0002', firstName: 'Bio', lastName: 'Kassim',
    absenceTypeId: uid(810), typeCode: 'CAP', confidential: false, policyId: null, policyVersion: null,
    periodStart: '2026-01-01', periodEnd: '2026-12-31', entryKind: 'adjustment_debit', quantity: 0.5, unit: 'open_days',
    effectiveOn: '2026-06-15', origin: 'admin', businessRef: null, reason: 'régularisation de reprise', reversalOf: null,
    paramsUsed: {}, idempotencyKey: 'adjust:demo', createdBy: uid(500), createdAt: '2026-06-15T09:00:00Z' },
];
